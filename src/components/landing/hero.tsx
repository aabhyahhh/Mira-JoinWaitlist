...
export function Hero({ onCtaClick }: { onCtaClick: () => void }) {
  return (
    <section className="relative overflow-hidden px-4 pb-16 pt-14 sm:pt-20">
      ...
      <div className="pointer-events-none absolute -left-20 top-40 h-56 w-56 rounded-full bg-coral-100/60 blur-3xl" />
      ...
      <div className="relative mx-auto flex max-w-xl flex-col items-center text-center">
        <motion.div
          ...
          className="mb-6 inline-flex items-center gap-2 rounded-full bg-coral-100 px-4 py-2 text-sm font-medium text-coral-700"
        >
        ...
        <motion.h1
          ...
          className="text-4xl leading-[1.1] text-charcoal-900 sm:text-5xl"
        >
        ...
        <motion.p
          ...
          className="mt-5 text-lg leading-relaxed text-charcoal-600"
        >
