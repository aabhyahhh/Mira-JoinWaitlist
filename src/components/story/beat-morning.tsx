    ...
    <Beat index={index} holdAtEnd>
      <div className="relative flex h-full w-full flex-col items-center justify-center px-6">
        <motion.div
          ...
          className="absolute top-[62%] flex items-center gap-3 rounded-2xl border border-parchment-300/30 bg-ink-900/40 px-5 py-4 backdrop-blur-sm"
        >
        ...
        <motion.h2
          ...
          className="absolute top-[74%] max-w-md text-balance text-center text-3xl leading-snug sm:text-4xl"
        >
